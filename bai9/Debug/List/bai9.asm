...
_main:
; .FSTART _main
; 0000 0019 DDRC = 0x80;// DDRC có 8 bit = b7 b6 ... b0, trong 8 bit nay thi bit 7 la noi ra, thì cho b7=1 => 1 0 0 0 0 0 0 0
	LDI  R30,LOW(128)
	OUT  0x14,R30
; 0000 001A DDRB = 0x00;
	LDI  R30,LOW(0)
	OUT  0x17,R30
; 0000 001B PORTB = 0x0C;//pull up lên 1 vì day la nút bam, truoc khi bam thi bang 1, sau khi bam = 0
	LDI  R30,LOW(12)
	OUT  0x18,R30
; 0000 001C 
