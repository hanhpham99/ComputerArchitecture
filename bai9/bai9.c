...
void main(void)
{
DDRC = 0x80;// DDRC có 8 bit = b7 b6 ... b0, trong 8 bit nay thi bit 7 la noi ra, thì cho b7=1 => 1 0 0 0 0 0 0 0
DDRB = 0x00;
PORTB = 0x0C;//pull up lên 1 vì day la nút bam, truoc khi bam thi bang 1, sau khi bam = 0
