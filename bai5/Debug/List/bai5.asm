...
; 0000 003F DDRD = 0x00;
	LDI  R30,LOW(0)
	OUT  0x11,R30
; 0000 0040 PORTD = 0x3C;
	LDI  R30,LOW(60)
	OUT  0x12,R30
; 0000 0041 
; 0000 0042 lcd_init(16);//8
	LDI  R26,LOW(16)
	RCALL _lcd_init
...
; 0000 0044     lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 0045     lcd_puts("hello_world");
	__POINTW2MN _0x3,0
	RCALL _lcd_puts
; 0000 0046 
; 0000 0047 while (1)
...
; 0000 004B          mode = 1;
	...
	LDI  R31,HIGH(1)
	MOVW R4,R30
; 0000 004C          _lcd_write_data(0x1C);
	LDI  R26,LOW(28)
	RCALL __lcd_write_data
; 0000 004D         }
; 0000 004E         if(CT2 == 0 || mode == 2){
_0x7:
	SBIS 0x10,5
	RJMP _0xB
	LDI  R30,LOW(2)
...
; 0000 0050          mode = 2;
	...
	LDI  R31,HIGH(2)
	MOVW R4,R30
; 0000 0051          _lcd_write_data(0x18);
	LDI  R26,LOW(24)
	RCALL __lcd_write_data
; 0000 0052         }
; 0000 0053         if(CT3 == 0 || mode == 3){
_0xA:
	SBIS 0x10,2
	RJMP _0xE
	LDI  R30,LOW(3)
...
; 0000 0056          lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 0057             lcd_puts("hello_world");
	__POINTW2MN _0x3,12
	RCALL _lcd_puts
; 0000 0058         }
; 0000 0059     }
